...
| D15 — resolved GUI Foundation 1 retained presentation model; static projection implemented through 1C | The retained GUI authority, ownership, presentation, interaction, publication, reconciliation, recovery and scope rules are specified below. [GuiFoundation1.md](GuiFoundation1.md) owns supporting rationale and implementation guidance; [GuiFoundation1A.md](GuiFoundation1A.md), [GuiFoundation1B.md](GuiFoundation1B.md) and [GuiFoundation1C.md](GuiFoundation1C.md) record the internal substrate, retained runtime and static presentation/CUI projection without claiming GUI-1D synchronization or interaction support. | Implement only through explicitly scoped GUI phases; qualify the complete boundary before assigning a release/API identity or advertising support |
