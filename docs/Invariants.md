...
| D15 — resolved GUI Foundation 1 retained presentation model; retained runtime implemented through 1B | The retained GUI authority, ownership, presentation, interaction, publication, reconciliation, recovery and scope rules are specified below. [GuiFoundation1.md](GuiFoundation1.md) owns supporting rationale and implementation guidance; [GuiFoundation1A.md](GuiFoundation1A.md) records the internal substrate and [GuiFoundation1B.md](GuiFoundation1B.md) records retained object/value/publication behavior without claiming presentation or rendering support. | Implement only through explicitly scoped GUI phases; qualify the complete boundary before assigning a release/API identity or advertising support |
