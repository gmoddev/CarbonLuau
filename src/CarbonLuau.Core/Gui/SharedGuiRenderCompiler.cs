...
namespace Carbon.Plugins
{
    public partial class CarbonLuau
    {
        ...
        {
            internal static GuiRenderPlan Compile(GuiTreeState State, GuiRetainedNode Screen, GuiProjectionNames Presentation, GuiLimits Limits)
            { return Compile(State, Screen, Presentation, Limits, null); }
            internal static GuiRenderPlan Compile(GuiTreeState State, GuiRetainedNode Screen, GuiProjectionNames Presentation,
            ...
            private static void AppendChildren(GuiTreeState State, GuiRetainedNode Parent, string ParentClientId,
                GuiProjectionNames Presentation, GuiLimits Limits, List<GuiRenderElement> Elements, bool AncestorsVisible,
            ...
            private static void AddLayout(GuiTreeState State, GuiRetainedNode Node, List<GuiRenderProperty> Result,
            ...
            private static void AddContentLayout(GuiTreeState State, GuiRetainedNode Node, List<GuiRenderProperty> Result)
            {
            ...
            private static GuiRenderProperty ContentProperty(GuiTreeState State, GuiRetainedNode Node, GuiRenderPropertyId Id)
            {
            ...
            private static Dictionary<ulong, GuiProjectedRect> ProjectChildren(GuiTreeState State, GuiRetainedNode Parent)
            {
            ...
            private static GuiContentRect ContentRect(GuiTreeState State, GuiRetainedNode Parent)
            {
            ...
            internal static bool NeedsCursorFor(GuiTreeState State, GuiRetainedNode Screen)
            { return HasVisibleInteractiveControl(State, Screen, true, true, new List<GuiClipRect>(), false); }
            internal static bool IsEffectivelyInteractive(GuiTreeState State, GuiRetainedNode Screen, GuiRetainedNode Target)
            {
            ...
            private static bool HasVisibleInteractiveControl(GuiTreeState State, GuiRetainedNode Parent, bool AncestorsVisible,
                bool AncestorsInteractive, List<GuiClipRect> ParentBoundsInClips, bool ParentCreatesClip)
            {
                Dictionary<ulong, GuiProjectedRect> Rectangles = ProjectChildren(State, Parent);
                foreach (ulong ChildId in Parent.Children) {
            ...
            private static void FindInteractiveEligibility(GuiTreeState State, GuiRetainedNode Parent, ulong TargetId,
