...
The GUI surface offers ScreenGui, Frame, TextLabel, TextButton, Roblox-familiar
layout/color values, explicit per-Player Show/Hide and secure Activated
callbacks. See the [GUI guide](docs/api/Gui.md). Authenticated-client visual,
