...
| Canonical Persistence Foundation 2 bounded derived-index Query architecture (implementation not started) | [D22 in Invariants.md](docs/Invariants.md#d22--persistence-foundation-2--bounded-derived-indexes-and-query) and [PersistenceFoundation2.md](docs/PersistenceFoundation2.md); basic Query requires no schema/index declaration, optional Indexes hints only prewarm/pin derived state, and D21 remains durability/storage owner. |
