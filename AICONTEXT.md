...
| Canonical Persistence Foundation 2 bounded query-schema/index architecture (implementation not started) | [D22 in Invariants.md](docs/Invariants.md#d22--persistence-foundation-2--bounded-query-schemas-and-indexed-query) and [PersistenceFoundation2.md](docs/PersistenceFoundation2.md); D21 remains durability/storage owner and the additive future schema/Query surface is assigned to the unreleased `0.5.0-experimental` identity. |
