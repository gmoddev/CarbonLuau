    ...
    try {
        ...
        try {
            $Files = @(
                ...
                @{ Source = (Join-Path $Root 'docs/api/Persistence.md'); Name = 'docs/api/Persistence.md' },
                @{ Source = (Join-Path $Root 'docs/api/Services/DataStoreService.md'); Name = 'docs/api/Services/DataStoreService.md' },
                @{ Source = (Join-Path $Root 'docs/api/Types/DataStore.md'); Name = 'docs/api/Types/DataStore.md' },
