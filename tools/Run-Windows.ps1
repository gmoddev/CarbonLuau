param([string]$Server = 'C:\Sandbox\Codex\Builds\CarbonLuau\server-win')
...
Copy-Item "$Artifacts\CarbonLuau.cszip" "$Server\carbon\plugins\CarbonLuau.cszip" -Force
