...
internal static class GuiFoundation1ATests
{
    ...
    private static void RunDescriptors()
    {
        ...
        Check(Classes.Length == 6 && Runtime.GuiSchema.Methods.Length == 9 && Runtime.GuiSchema.Events.Length == 1 &&
        ...
        Check(String.Join(",", PublicNames) == "Frame,ScreenGui,TextButton,TextLabel", "exact public class boundary");
